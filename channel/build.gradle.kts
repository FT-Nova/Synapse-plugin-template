...
tasks.shadowJar {
    // Do not bundle synapse-plugin-api — provided by the loader at runtime
    dependencies {
    ...
    manifest {
        attributes(
            "Plugin-Id" to "your-author/your-channel-name",  // TODO: match manifest.yml
            "Plugin-Version" to version,
            "Plugin-Type" to "channel"
        )
    }
}
